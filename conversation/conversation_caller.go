...
func InitConversation(conn *grpc.ClientConn) {
	...
	ClearUserConversationMsgCaller.SetConn(conn)
	GetConversationReadCursorsCaller.SetConn(conn)
}
...
var (
	...
	ClearUserConversationMsgCaller                = rpccall.NewRpcCaller[ClearUserConversationMsgReq, ClearUserConversationMsgResp](Conversation_ClearUserConversationMsg_FullMethodName)
	GetConversationReadCursorsCaller              = rpccall.NewRpcCaller[GetConversationReadCursorsReq, GetConversationReadCursorsResp](Conversation_GetConversationReadCursors_FullMethodName)
)
