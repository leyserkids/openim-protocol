...
func InitMsg(conn *grpc.ClientConn) {
	...
	GetLastMessageSeqByTimeCaller.SetConn(conn)
	GetLastMessageCaller.SetConn(conn)
	GetConversationUserReadSeqsCaller.SetConn(conn)
}
...
var (
	...
	GetLastMessageSeqByTimeCaller          = rpccall.NewRpcCaller[GetLastMessageSeqByTimeReq, GetLastMessageSeqByTimeResp](Msg_GetLastMessageSeqByTime_FullMethodName)
	GetLastMessageCaller                   = rpccall.NewRpcCaller[GetLastMessageReq, GetLastMessageResp](Msg_GetLastMessage_FullMethodName)
	GetConversationUserReadSeqsCaller      = rpccall.NewRpcCaller[GetConversationUserReadSeqsReq, GetConversationUserReadSeqsResp](Msg_GetConversationUserReadSeqs_FullMethodName)
)
